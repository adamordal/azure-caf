...
resource "azurerm_log_analytics_workspace" "law" {
  ...
  reservation_capcity_in_gb_per_day = can(var.log_analytics.reservation_capcity_in_gb_per_day) || can(var.log_analytics.reservation_capacity_in_gb_per_day) ? try(var.log_analytics.reservation_capcity_in_gb_per_day, var.log_analytics.reservation_capacity_in_gb_per_day) : null
